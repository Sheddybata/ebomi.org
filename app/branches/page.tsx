  ...
  return (
    <div className="pt-20 min-h-screen bg-gray-50">
      ...
      <section className="bg-navy text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-center mb-4">
            ...
            <h1 className="text-4xl md:text-5xl font-bold">{t.branches.title}</h1>
          </div>
          <p className="text-xl text-gray-300 text-center">{t.branches.subtitle}</p>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div>
          <h2 className="text-3xl font-bold text-navy-dark mb-8 text-center">{t.branches.allBranches}</h2>
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <div className="mb-4 flex-grow">
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <span className="text-sm font-semibold text-gray-700">{t.branches.coordinator}</span>
                    </div>
                  ...
                  <div className="border-t border-gray-200 pt-4">
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <span className="text-sm font-semibold text-gray-700">{t.branches.contact}</span>
                    </div>
